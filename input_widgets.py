...
st.write('Hello', name)
age = st.number_input('Enter your age', step=1,min_value=1,max_value=90)
st.write('Your age is', age)
bio = st.text_area('Enter your bi', height=200)
birthday = st.date_input('Enter your birthday')
st.write(birthday)
time = st.time_input('What time did your wake up?')
st.write(time)
...
if clicked:
    st.write('Botton clicked!')
checked = st.checkbox('Check me!')
if checked:
    st.write('Check checked')
